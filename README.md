...
The plugin code is written in kotlin 1.9.20 so the same has to be set to the android project of yours for compilation.
Change the kotlin_version to 1.9.20 in your `android/build.gradle` file.
